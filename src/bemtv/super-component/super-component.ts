      ...
      case "object":
        ...
        for (const i of values) {
          if (!isStringOrNumber(i)) {
            ...
            throw `${LIBRARY_NAME_IN_ERRORS_MESSAGE} In the “${data.componentName}” component the template with TemplateStringsArray has a value that is not string, number or uses ttFunctions: “${values}”`;
          }
        }
